...
use crate::{library::{sequence::Sequence, u8::U8, u16::U16, button::Button, union::Union, constraint::Constraint}, core::{DataModel, bolts::ChildMap}};
...
//     let rr_type_a = Rc::new(Constraint::new("rr_type_a", uint16.clone(), Rc::new(|ctx| {
//         ctx.child().int() == 1
//     })));

//     let rr_type_ns = Rc::new(Constraint::new("rr_type_ns", uint16.clone(), Rc::new(|ctx| {
//         ctx.child().int() == 2
//     })));
